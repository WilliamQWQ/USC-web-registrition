...
#define MYPORT "23745"  //serverEE's port number
...
int main(void){
    ...
    printf("The serverEE is up and running using UDP on port 23745\n");
    ...
    while(1){
        ...
        cout << "The ServerEE recieved a request from the Main Server about the "<< category <<" of " << code <<endl; 
        reply = "0";
        ...
        cout<< "The ServerEE finished sending the response to the Mian Server "<< endl;
